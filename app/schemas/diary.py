...
class AnalysisResponse(BaseModel):
    ...
    emotion_group: str = Field(..., example="negative", description="情绪大类")
    emotion_valence: str = Field(..., example="unpleasant", description="情绪愉悦度")
    emotion_energy: str = Field(..., example="high", description="情绪能量水平")
